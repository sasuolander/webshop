...
export function addProduct(name,additionalInfo,price){
    ...
    insertRequest(urlBase + "product", product, { headers: {
            'Content-Type': 'application/json',
            'Access-Control-Allow-Origin': '*',
            'x-access-token':getCookie("token")
        }
...
export function getProducts() {
    return getRequestDelegate(urlBase + "products", { headers: {
            'Content-Type': 'application/json',
            'Access-Control-Allow-Origin': '*',
            'x-access-token':getCookie("token")
        }
...
export function updateProduct(id,name,additionalInfo,price){
    ...
    insertRequest(urlBase + "product/update", product, { headers: {
            'Content-Type': 'application/json',
            'Access-Control-Allow-Origin': '*',
            'x-access-token':getCookie("token")
        }
...
export function deleteProduct(id){
    deleteRequest(urlBase + "product", id, { headers: {
            'Content-Type': 'application/json',
            'Access-Control-Allow-Origin': '*',
            'x-access-token':getCookie("token")
        }
...
export function getOrdersById(id) {
    return getRequestDelegate(urlBase + "ordersByUserId",id, { headers: {
            'Content-Type': 'application/json',
            'Access-Control-Allow-Origin': '*',
            'x-access-token':getCookie("token")
        }
...
export function updateOrder(id, userId,productId){
    ...
    insertRequest(urlBase + "order/update", order, { headers: {
            'Content-Type': 'application/json',
            'Access-Control-Allow-Origin': '*',
            'x-access-token':getCookie("token")
        }
...
export function deleteOrder(id){
    deleteRequest(urlBase + "order", id, { headers: {
            'Content-Type': 'application/json',
            'Access-Control-Allow-Origin': '*',
            'x-access-token':getCookie("token")
        }
...
export function addOrder(order){
    insertRequest(urlBase + "order", order, { headers: {
            'Content-Type': 'application/json',
            'Access-Control-Allow-Origin': '*',
            'x-access-token':getCookie("token")
        }
